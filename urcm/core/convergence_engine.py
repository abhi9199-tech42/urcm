...
# Convergence engine constants
DEFAULT_RHO_THRESHOLD = 0.5
DEFAULT_CONVERGENCE_EPSILON = 1e-3
DEFAULT_MAX_STEPS = 50
DEFAULT_BEAM_WIDTH = 3
DEFAULT_OSCILLATION_WINDOW = 4
DEFAULT_OSCILLATION_STD_THRESHOLD = 0.02
...
class MuConvergenceEngine:
    ...
    def __init__(
        ...
        competition_beam_width: int = DEFAULT_BEAM_WIDTH,
        oscillation_window: int = DEFAULT_OSCILLATION_WINDOW,
        oscillation_std_threshold: float = DEFAULT_OSCILLATION_STD_THRESHOLD
    ):
        """
